!
!   THIS FILE IS PART OF CMUMPS VERSION 4.3.2
...
!  with this License. Up-to-date copies of the CMUMPS package can be
!  obtained from the Web page http://www.enseeiht.fr/apo/CMUMPS/
!
...
!  and is available at http://www.enseeiht.fr/apo/CMUMPS/.
!
...
!  RT/APO/99/2 (1999)  and is available at http://www.enseeiht.fr/apo/CMUMPS/.
!
!  None of the text from the Copyright notice up to and
!  including this line shall be removed or altered in any way.
!
!     $Id: cmumps_root.h,v 1.7 2003/05/13 13:34:16 jylexcel Exp $
