!
!   THIS FILE IS PART OF SMUMPS VERSION 4.3.2
...
!  with this License. Up-to-date copies of the SMUMPS package can be
!  obtained from the Web page http://www.enseeiht.fr/apo/SMUMPS/
!
...
!  and is available at http://www.enseeiht.fr/apo/SMUMPS/.
!
...
!  RT/APO/99/2 (1999)  and is available at http://www.enseeiht.fr/apo/SMUMPS/.
!
!  None of the text from the Copyright notice up to and
!  including this line shall be removed or altered in any way.
!
!     $Id: smumps_struc.h,v 1.30 2003/11/12 15:56:08 jylexcel Exp $
