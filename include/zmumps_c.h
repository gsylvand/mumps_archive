...
*/
/* $Id: zmumps_c.h,v 1.23 2005/10/13 09:51:11 jylexcel Exp $ */
...
void zmumps_affect_uns_perm_(F_INT * f77sym_perm);
void zmumps_affect_sym_perm_(F_INT * f77uns_perm);
...
void zmumps_f77_(F_INT *job, F_INT *sym, F_INT *par, F_INT * comm_fortran,
F_INT *n, F_INT *icntl,
