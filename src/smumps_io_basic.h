/*
   ...
   THIS FILE IS PART OF MUMPS VERSION 4.7.1
...
*/
/*    $Id: smumps_io_basic.h,v 1.50 2006/12/20 09:41:25 aguermou Exp $  */
...
#ifndef _WIN32
#define SMUMPS_IO_FLAG_O_DIRECT 0
#endif
...
int smumps_io_do_write_block(void * address_block,int * block_size,int * pos_in_file,int * file_number,int * type,int * ierr);
int smumps_io_do_read_block(void * address_block,int * block_size,int * from_where,int * file_number,int * type,int * ierr);
