...
*/
/*    $Id: zmumps_io_basic.c,v 1.79 2006/04/13 11:02:26 jylexcel Exp $  */
...
#ifndef _WIN32
  *(zmumps_io_pfile_pointer_array+zmumps_io_current_file_number)=open(name,zmumps_flag_open);
...
#ifndef _WIN32
    *(zmumps_io_pfile_pointer_array+i)=open(*(zmumps_io_pfile_name+i),zmumps_flag_open);
