...
*/
/*    $Id: zmumps_io_basic.h,v 1.28 2006/01/19 17:15:23 aguermou Exp $  */
...
#define ZMUMPS_IO_FLAGS O_RDWR|O_DIRECT
#else
#define ZMUMPS_IO_FLAGS O_RDWR
#endif
#endif
...
#if defined (CINES_)
#define ZMUMPS_OOC_DEFAULT_DIR "/tmpp/eagullo"
#else
